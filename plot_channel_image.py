...
if __name__ == '__main__':
    ...
    parser.add_argument('--base-weights', type=str, default='runs/train/exp-ghost-dbb/weights/best.pt', help='base weights path')
    parser.add_argument('--prune-weights', type=str, default='runs/train/ghostnet-lamp-2.0/weights/best.pt', help='prune weights path')
