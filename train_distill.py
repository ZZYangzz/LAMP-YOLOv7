...
if __name__ == '__main__':
    ...
    parser.add_argument('--teacher_weights', type=str, default='', help='initial weights path (teacher)')
    parser.add_argument('--teacher_cfg', type=str, default='', help='initial model.yaml path (teacher)')
    ...
    parser.add_argument('--feature_loss_type', type=str, default='cwd', choices=['mimic', 'cwd', 'mgd'], help='feature loss type in kd_loss')
